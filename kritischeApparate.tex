...
\footnote{%
	...
	Auf das Paket \Package{ednotes} von Uwe Lück gehe ich hier nicht weiter ein, ein ausführlicher \textsl{TUGboat}-Artikel liegt dem Paket bei. Eine Arbeit, die mit diesem Paket erstellt wurde, ist \cite{mariev:joh_ant}.}
